tAssistance.Group = function(parentNode, width, trace_id){
	this.scale_x_time = 1000/tAssistance.Datetime.units[6];
	this.timeoffset;
	this.xoffset;
	this.childs = [];
	this.element;
	...
	this.update = function(){
		...
		var tstore = new tStore.OzaTStore();
...
//		}
		...
		var firstMinor = timeoffset - mod;
		
		var x = this.getX(firstMinor, timeoffset, xoffset, scale_x_time);
		
		text = document.createElementNS(tAssistance.svg.svgNS,"text");
		...
		text.textContent = (new Date(firstMinor));
